    ...
    public void SiguienteGeneracion() {
        ...
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz.length; j++) {
                ...
                vivas = matriz2[i][j];
                //  Si una célula está viva y tiene dos o tres vecinos vivos, la célula permanece viva en la siguiente
                ...
                // Si una célula viva que no tiene vecinos vivos o un solo vecino vivo muere por aislamiento en la próxima generación.
                if (vivas < 2) {
                    matriz3[i][j] = casillamuerta;
                }
                //Una célula viva que tiene cuatro o más vecinos vivos muere por sobrepoblación en la próxima generación.
                if (matriz[i][j].isCelviva() && vivas > 3) {
                    matriz3[i][j] = casillamuerta;
                }
                //Una celda muerta con exactamente tres vecinos vivos da como resultado un nacimiento y cobra vida en la siguiente generación. 
